...
.nv-top-slider {
  ...
  &:not([data-post-type='page']) {
    position: relative;
    background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3)), repeating-linear-gradient(-45deg, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.05) 1.414px, transparent 0px, transparent 6px);
    /*border-radius: 0 0 15px 15px;*/
    /*box-shadow: 0 -1px rgba(255,255,255,.2) inset,0 0 0 1px rgba(0,0,0,.4), 0 0 20px rgba(0,0,0,.3);*/
    @media (min-width: 768px) {
      //手机性能差，大屏幕才显示动画
      animation: slider-bg-moving linear 0.35s infinite;
    }
  }
}
