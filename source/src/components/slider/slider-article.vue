	...
	<div class="container flex items-center xxs:flex-col-reverse xs:flex-col-reverse xxs:justify-center xs:justify-center">
		<div class="metas" >
			...
			<div class="info">
				...
				<span><svgIcon name="clock" height="13" />{{moment(post.modified_time).format(`${$store.state.theme_settings.nv_date_format || 'l'} ${$store.state.theme_settings.nv_time_format || 'LT'}`)}}</span>
			</div>
		</div>
		<div class="coverflow">
